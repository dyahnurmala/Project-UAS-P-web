    ...
    <header>
        <div class="container">
            <h1><a href="index.php">Botanic Bliss</a></h1>
                <ul>
                    <li><a href="#products" class="nav__link">Product</a></li>
...
<!--==================== PRODUCTS ====================-->
        <section class="product section container" id="products">
                ...
                <p class="product__description">
                    Berikut adalah beberapa tanaman pilihan dari showroom kami, semuanya dalam kondisi sangat baik 
                    bentuk yang sangat baik dan memiliki rentang hidup yang panjang. Beli dan nikmati kualitas terbaik.
                </p>
                ...
                <div class="product__container grid">
                    <article class="product__card">
                        ...
                        <h3 class="product__title">Cacti Plant <br> Rp 50.000</h3>
                    </article>

                    <article class="product__card">
                        <div class="product__circle"></div>
                        <img src="assets/img/product2.png" alt="" class="product__img">
                        <h3 class="product__title">Cactus Plant<br>Rp 65.000</h3>
                    </article>

                    <article class="product__card">
                        <div class="product__circle"></div>
                        <img src="assets/img/product3.png" alt="" class="product__img">
                                <h3 class="product__title">Aloe Vera Plant<br>Rp 75.000</h3>
                    </article>

                    <article class="product__card">
                        <div class="product__circle"></div>
                        <img src="assets/img/product4.png" alt="" class="product__img">
                        <h3 class="product__title">Succulent Plant<br>Rp 70.000</h3>
                    </article>

                    <article class="product__card">
                        <div class="product__circle"></div>
                        <img src="assets/img/product5.png" alt="" class="product__img">
                        <h3 class="product__title">Parodia Plant<br>Rp 70.000</h3>
                    </article>

                    <article class="product__card">
                        <div class="product__circle"></div>
                        <img src="assets/img/product6.png" alt="" class="product__img">
                        <h3 class="product__title">Green Plant<br>Rp 55.000</h3>
                        </button>
                </article>
            </div>
        </section>
